...
public class TempMainForAnimation {
	...
	public static void main(String[] args) {
		...
		cupComponents[0] = new Cup(215,423, marble);
		cupComponents[1] = new Cup(328,423, marble);
		cupComponents[2] = new Cup(441,423, marble);
		cupComponents[3] = new Cup(554,423, marble);
...
<<<<<<< HEAD
		...
		animation.animate(cupComponents, 12, 4);
=======
